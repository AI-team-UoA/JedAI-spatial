...
import dit.anonymous.webapp.datatypes.Parameter;
    ...
    public static IEntityMatching configureEntityMatchingMethod(String emMethodName, List<Parameter> parameters) {
		...
		switch (emMethodName) {
			...
			case Options.GROUP_LINKAGE:
				...
				if(WorkflowManager.er_mode == Options.DIRTY_ER)
