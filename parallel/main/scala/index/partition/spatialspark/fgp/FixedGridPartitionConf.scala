...
class FixedGridPartitionConf(val gridDimX: Int, val gridDimY: Int, val extent: Envelope) extends PartitionConf(SpatialSparkPartitionMethod.FGP) with Serializable {
