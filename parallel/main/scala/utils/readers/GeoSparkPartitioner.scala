...
case class GeoSparkPartitioner(source: SpatialRDD[Geometry], partitions: Int, gt: Constants.GeoSparkGridType.GeoSparkGridType = Constants.GeoSparkGridType.QUADTREE) {

  lazy val gridType: GridType = gt match {
    case Constants.GeoSparkGridType.KDBTREE => GridType.KDBTREE
    case Constants.GeoSparkGridType.RTREE => GridType.RTREE
    case Constants.GeoSparkGridType.QUADTREE => GridType.QUADTREE
    case Constants.GeoSparkGridType.EQUALGRID => GridType.EQUALGRID
    case Constants.GeoSparkGridType.HILBERT => GridType.HILBERT
    case Constants.GeoSparkGridType.VORONOI => GridType.VORONOI
  }
